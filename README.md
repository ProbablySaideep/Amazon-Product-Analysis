...
![Link to my Dashboard]([visualizations/dashboard_preview.png](https://public.tableau.com/views/AmazonSalesAnalysis_17788486659930/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link))
